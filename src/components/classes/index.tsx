...
const classesItem: Array<ClassesType> = [
  {
     ...
     py-40">
      ...
      >
        ...
        <ul className="w-[2800px] whitespace-nowrap">
          {classesItem.map((item: ClassesType, index:number) => (<ClassItem key={index}  name={item.name} description={item.description} image={item.image} />))}
        </ul>
        </div>
      </motion.div>
    </section>
