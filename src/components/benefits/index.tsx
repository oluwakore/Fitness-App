...
import { BenefitItemTypes, SelectedPage } from '@/shared/types';
import { motion } from 'framer-motion';
import HText from '../headertext';
...
const benefitItems: Array<BenefitItemTypes> = [
  {
  ...
  return (
    ...
    >
      ...
      >
        ...
        variants={container}
        >
      {benefitItems.map((item: BenefitItemTypes, index:number) => (<BenefitItem key={index} title={item.title} icon={item.icon} description={item.description} setSelectedPage={setSelectedPage} />))}
        </motion.div>
